...
- Маленька літера на початку
  - [x] Захарії 2 4 `йому. 4 сказав той`: додати `І` на початку бо TBS додало
  - [x] Захарії 4 1 `фиговину. 1 вернувся той`: додати `І` на початку бо TBS додало
  - [x] Захарії 4 4 `ліворуч. 4 запитавсь`: додати `І` на початку бо TBS додало
  - [x] Захарії 7 1 `вашого. 1 четвертому`: додати `У` на початку бо TBS додало
