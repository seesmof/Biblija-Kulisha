...
def get_Book_name_from_full_file_name(file_name: str):
    if "usfm" not in file_name.lower():
        print(
            f"When trying to get Book name from file name: File format is not USFM for file named {file_name}"
        )
